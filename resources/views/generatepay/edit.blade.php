	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($generatePayById, ['route'=>['generatepay.update',$generatePayById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
						<div class="form-group">
							{!! Form::label('Month','',['class'=>'control-label'])!!}
							{!! Form::text('date',date('M - Y',strtotime($generatePayById->date)),['class'=>'form-control','id'=>'datetimepicker1']) !!}
							@if($errors->has('date'))
		                        ...
		                        @foreach($designationAll as $designId => $designation)
		                            ...
		                            <?php
		                                ...
		                                foreach ($approvedPayByDesignationId as $approvedPayByDesignation) {
		                                    ...
		                                    echo "<option value='$approvedPayByDesignation->id' $selected>$approvedPayByDesignation->hospital_type</option>";
		                                }
		                            ?>
		                            </optgroup>
		                        @endforeach
