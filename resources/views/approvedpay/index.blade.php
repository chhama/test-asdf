	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::open(['route'=>'approvedpay.store','class'=>'form-horizontal']) !!}
						<div class="form-group">
							{!! Form::label('Hospital Type','',['class'=>'control-label'])!!}
							{!! Form::select('hospital_type',[''=>'']+$hospital_type,'',['class'=>'form-control','id'=>'hospital_type']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('designation_id',[''=>'']+$designationAll,'',['class'=>'form-control','id'=>'designation_id']) !!}
