...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Edit Loan Head</strong></div>
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($loanHeadById, ['route'=>['loanhead.update',$loanHeadById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
