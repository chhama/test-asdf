...
<div class="container">
	<div class="row">
		...
		<div class="col-md-3">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Edit Loan</strong></div>
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($loanById, ['route'=>['loan.update',$loanById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
					{!! Form::hidden('staff_id',$staff_id) !!}
						<div class="form-group">
							{!! Form::label('Loan Head','',['class'=>'control-label'])!!}
							{!! Form::select('loan_head_id',$loanHeadAll,null,['class'=>'form-control','id'=>'loan_head_id']) !!}
