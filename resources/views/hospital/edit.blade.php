...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Edit Hospital</strong></div>
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($hospitalById, ['route'=>['hospital.update',$hospitalById->id],'method'=>'patch','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('hospital_category_id',$hospitalCategoryAll,$hospitalById->hospital_category_id,['class'=>'form-control']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('type',$type,$hospitalById->type,['class'=>'form-control']) !!}
							@if($errors->has('type'))
						...
						<div class="form-group">
							...
							{!! Form::select('district_id',$districtAll,$hospitalById->district_id,['class'=>'form-control']) !!}
						...
						<div class="form-group">
							...
							@endif
							<img src="{{ $hospitalById->photo1 }}" class="img-thumbnail">
						</div>
						<div class="form-group">
							...
							@endif
							<img src="{{ $hospitalById->photo2 }}" class="img-thumbnail">
						</div>
						<div class="form-group">
							...
							@endif
							<img src="{{ $hospitalById->photo3 }}" class="img-thumbnail">
						</div>
						<div class="form-group">
